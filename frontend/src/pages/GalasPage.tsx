  ...
  return (
    <div className="container">
      <div className="flex-between">
        ...
        <button className="btn btn-ghost btn-sm" onClick={loadGalas}>
          {t("galas.actualizar")}
        </button>
      </div>
          ...
          galas.map((gala, idx) => {
            ...
            return (
              <div
                ...
                style={{
                  cursor: "pointer",
                  borderBottom: idx === galas.length - 1 ? "none" : undefined,
                }}
                role="button"
                tabIndex={0}
              ...
              >
                ...
                >
                  <span className="badge badge-blue">
                    {t("galas.votos", { n: totalVotos })}
                  </span>
                  <span
                    style={{ color: "var(--gray-400)", fontSize: ".82rem" }}
                  >
                    {t("galas.verDetalle")}
                  </span>
                </div>
